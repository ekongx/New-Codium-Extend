	...
	<div id="container">
		<div id="content">
			...
			<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="entry-date"><?php unset($previousday); printf(__('%1$s ', 'codium_extend'), the_date('', '', '', false), get_the_time()) ?></div>
					...
					<?php wp_link_pages("\t\t\t\t\t<div class='page-link'>".__('Pages: ', 'codium_extend'), "</div>\n", 'number'); ?>
						...
						<div class="entry-meta">
							<?php the_tags(__('<span class="edit-links">Tags ', 'codium_extend'), ", ", "</span>\n\t\t\t\t\t<span class=\"meta-sep\">|</span>\n") ?>
