	...
	<div id="container">
		<div id="content">
			...
			<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				<h2 class="entry-title"><a href="<?php the_permalink() ?>" title="<?php printf(__(' %s', 'codium_extend'), esc_html(get_the_title(), 1)) ?>" rel="bookmark"><?php the_title() ?></a></h2>
				<div class="entry-date"><span ><?php printf(__('%s', 'codium_extend'), get_the_category_list(' ')) ?></span>&nbsp;<?php unset($previousday); printf(__('%1$s  ', 'codium_extend'), the_date('', '', '', false), get_the_time()) ?></div> 
					...
					<?php wp_link_pages("\t\t\t\t\t<div class='page-link'>".__('Pages: ', 'codium_extend'), "</div>\n", 'number'); ?>
						...
						<div class="entry-meta">
							<?php the_tags(__('<span class="meta-nav">Tags ', 'codium_extend'), ", ", "</span>\n\t\t\t\t\t<span class=\"meta-sep\">|</span>\n") ?>
